...
-- ----------------------------
-- Table structure for dapartment_manage
-- ----------------------------
DROP TABLE IF EXISTS `dapartment_manage`;
CREATE TABLE `dapartment_manage`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `purchase_information`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `approver` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `closing_date` datetime(0) NULL DEFAULT NULL,
  `auditor` varbinary(50) NULL DEFAULT NULL,
  `prepare_people` varbinary(50) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `repo_user` VALUES (1, 'superAdmin', '$2a$10$SRszJgnSmghpc48ILn2mUu1bXVIDQOFJXZvRBiMITi16jusAExxXS', 'superAdmin', 'superAdmin');
INSERT INTO `repo_user` VALUES (5, 'departAdmin', '$2a$10$E4LvCkVehkZxRWz5AUyALePfufJCLeAfuaoN/B.YS3zNvTA1JqjNG', 'departAdmin', 'departAdmin');
INSERT INTO `repo_user` VALUES (6, 'repoKeeper', '$2a$10$cjZMR5sp/hNrCmCIrQ.YZuf4ZQUrkF5zxym/d3QqpILKa/cc2Qsza', 'repoKeeper', 'repoKeeper');
INSERT INTO `repo_user` VALUES (7, 'staff', '$2a$10$yDrNpjE1g01nk9CIr.ildua.x0yUVR7YkNGsjMPa5cNqiYzgbfA4K', 'repoKeeper', 'staff');
