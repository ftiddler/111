...
CREATE TABLE `purchase_information`  (
  ...
  `prepare_people` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `purchase_information` VALUES (1, '审批人一', '2021-04-28 16:08:04', '审核人一', '编制人一');
INSERT INTO `purchase_information` VALUES (2, '审批人二', '2021-04-27 16:08:50', '审核人二', '编制人二');
...
INSERT INTO `repo_role` VALUES (3, 2, 3, '部门一普通用户');
INSERT INTO `repo_role` VALUES (4, 1, 4, '单位库管员');
INSERT INTO `repo_role` VALUES (5, 1, 5, '单位系统管理员');

-- ----------------------------
-- Table structure for repo_role_authority
-- ----------------------------
DROP TABLE IF EXISTS `repo_role_authority`;
CREATE TABLE `repo_role_authority`  (
  ...
  CONSTRAINT `repo_role_authority_ibfk_1` FOREIGN KEY (`r_id`) REFERENCES `repo_role` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `repo_role_authority_ibfk_2` FOREIGN KEY (`a_id`) REFERENCES `repo_authority` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of repo_role_authority
-- ----------------------------
INSERT INTO `repo_role_authority` VALUES (1, 1, 2);
INSERT INTO `repo_role_authority` VALUES (2, 1, 3);
INSERT INTO `repo_role_authority` VALUES (3, 2, 1);
INSERT INTO `repo_role_authority` VALUES (8, 2, 3);
INSERT INTO `repo_role_authority` VALUES (9, 3, 4);
INSERT INTO `repo_role_authority` VALUES (10, 4, 5);
INSERT INTO `repo_role_authority` VALUES (11, 5, 6);
...
-- ----------------------------
INSERT INTO `repo_user` VALUES (1, '单位领导账号', '$2a$10$SRszJgnSmghpc48ILn2mUu1bXVIDQOFJXZvRBiMITi16jusAExxXS', '100001');
...
INSERT INTO `repo_user` VALUES (5, '系统管理员账号', NULL, '100005');
...
CREATE TABLE `section`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1832 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `template`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'name\r\n' ROW_FORMAT = Compact;
